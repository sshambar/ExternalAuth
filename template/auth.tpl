...
<form method="post" action="{$F_ACTION}" class="properties">
  ...
  <fieldset>
    <legend>
      <span class="icon-cog-alt icon-purple"></span>
...
<form method="post" action="{$F_ACTION}" class="properties">
  ...
  <fieldset>
    <legend>
      <span class="icon-ccw icon-red"></span>
      {'Fallback Authentication'|translate}
    </legend>
    {if $EA.fallback}
...
<form method="post" action="{$F_ACTION}" class="properties">
  ...
  <div id="configContent">
    ...
    <fieldset>
      <legend>
	<span class="icon-lock icon-yellow"></span>
	{'Authentication Options'|translate}
      </legend>
      <ul>
	<li>
	  <label for="remote_name">{'Server Login Variables'|translate}</label>
	  <a class="icon-help-circled tiptip" style="cursor:help" title="{'Comma separated list of $_SERVER variables searched to locate the Remote User\'s login (in order)'|translate}"></a>
	  <br>
	...
	<li>
	  ...
	  <a class="icon-help-circled tiptip" style="cursor:help" title="{'Comma separated list of Remote Users that are considered guests.'|translate} {'Empty or missing Remote Users are always guests.'|translate}"></a>
	  <br>
	...
	<li>
	  ...
	  <a class="icon-help-circled tiptip" style="cursor:help" title="{'These requests use their own login API. This setting will only be useful if you have a custom-built client (or a specially configured proxy server).'|translate}"></a>
    ...
    <fieldset>
      <legend>
	<span class="icon-arrows-cw icon-blue"></span>
	{'Password Sync Options'|translate}
      </legend>
      <ul>
	<li>
	  <label class="font-checkbox">
	  ...
	  <a class="icon-help-circled tiptip" style="cursor:help" title="{'Overwrite the Piwigo password with Remote User password (if not empty).'|translate}"></a>
	</li>
	<li>
	  <label for="remote_password">{'Server Password Variables'|translate}</label>
	  <a class="icon-help-circled tiptip" style="cursor:help" title="{'Comma separated list of $_SERVER variables searched to locate the Remote User\'s password (in order).  The password is used for sync and user auto-creation.'|translate}"></a>
	  <br>
    ...
    <fieldset>
      <legend>
	<span class="icon-link icon-green"></span>
	{'Remote Authentication Links'|translate}
      </legend>
      <ul>
	<li>
	  <label for="login_url">{'Login URL'|translate}</label>
	  <a class="icon-help-circled tiptip" style="cursor:help" title="{'If not empty, link is added to the menu when appropriate.'|translate} {'References to relative \'%(url)\' or absolute \'%(absurl)\' URLs can be included (will be URL escaped).'|translate}"></a>
	  <br>
	  ...
	  <a class="icon-help-circled tiptip" style="cursor:help" title="{'Label will be translated if possible'|translate}"></a>
    ...
    <fieldset>
      <legend>
	<span class="icon-lifebuoy icon-blue"></span>
	...
	<li>
	  ...
	  <a class="icon-help-circled tiptip" style="cursor:help" title="{'Send debug messages to Piwigo logs.  Debug logging can also be enabled by setting %s'|translate:'$conf[\'externalauth_debug\']'}"></a>
	</li>
      </ul>
    </fieldset>
  </div>
